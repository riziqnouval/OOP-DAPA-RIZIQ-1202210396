...
public class Handphone extends Perangkat {
    ...
    public void kirimSMS(int no_hp){
        System.out.println("Handphone berhasil berhasil mengirim SMS ke No "+ no_hp);
    }

    public void kirimSMS(int no_hp1, int no_hp2){
        System.out.println("Handphone berhasil berhasil mengirim SMS ke No "+ no_hp1 +" dan ke No "+ no_hp2);
    } 
